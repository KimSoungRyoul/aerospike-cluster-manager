...
import type { ConnectionProfileResponse, ConnectionStatus } from "@/lib/types/connection";
...
export function useConnectionHealth(connections: ConnectionProfileResponse[] | null) {
